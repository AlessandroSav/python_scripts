...
LDIAGFLX_49r2b = {
    'p82' : 'dudt_dyn'      , 'p83' : 'dvdt_dyn'    ,
    'p84' : 'dTdt_dyn'      , 'p85' : 'dqdt_dyn'    ,
    'p86' : 'dco2dt_dyn'    , 'p87' : 'co2flx_dyn' ,
    # cloud
    'p88' : 'dTdt_cloud'    , 'p89' : 'Tflx_cloud'  ,
    'p90' : 'dqdt_cloud'    , 'p91' : 'qflx_cloud'  ,
    # diffusion
    'p92' : 'dudt_diff'  , 'p93' : 'uflx_diff' ,
    'p94' : 'dvdt_diff'   , 'p95' : 'vflx_diff'  ,
    'p96' : 'dTdt_diff'   , 'p97' : 'Tflx_diff'  ,
    'p98' : 'dqdt_diff'   , 'p99' : 'qflx_diff'  ,
    'p100': 'dco2dt_diff' , 'p101': 'co2flx_diff',
    # convection
    'p102': 'dudt_conv'   , 'p103': 'uflx_conv'  ,
    'p104': 'dvdt_conv'   , 'p105': 'vflx_conv'  ,
    'p106': 'dTdt_conv'   , 'p107': 'Tflx_conv'  ,
...
for file in files:
    ...
    for var, var_data in ds_single.variables.items():
        ...
        if var == 'dco2dt_dyn':
            ...
            ds_single[var].attrs['long_name'] = 'Time-integrated total CO2 flux at the surface'
        ## CH4
        if var == 'dch4dt_dyn':
